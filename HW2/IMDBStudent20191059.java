...
public class IMDBStudent20191059 {
	...
	public static class IMDBMapper extends Mapper<Object, Text, DoubleString, Text> {
		...
		protected void setup(Context context) throws IOException, InterruptedException {
			...
			if (filename.indexOf("movies.txt") != -1) movieFile = true;
	...
	public static void main(String[] args) throws Exception {
		...
		if (otherArgs.length != 3) {
			System.err.println("Usage: IMDBStudent20191059 <in> <out> <k>");
			System.exit(2);
		}
		conf.setInt("topK", Integer.valueOf(otherArgs[2]));
		Job job = new Job(conf, "IMDBStudent20191059");
		job.setJarByClass(IMDBStudent20191059.class);
